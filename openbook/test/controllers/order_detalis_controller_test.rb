...
class OrderDetalisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_detali" do
    assert_difference('OrderDetali.count') do
      post order_detalis_url, params: { order_detali: { books_id: @order_detali.books_id, order_id: @order_detali.order_id, price: @order_detali.price } }
    end
  ...
  test "should update order_detali" do
    patch order_detali_url(@order_detali), params: { order_detali: { books_id: @order_detali.books_id, order_id: @order_detali.order_id, price: @order_detali.price } }
